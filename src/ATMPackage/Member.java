...
public class Member
{
    ...
    public boolean requestChangePin(int possiblePin) {
        ...
        try {
            ...
            if (memberInfo.next() != false) {
                //update the requestChangePin in database
                statement2.execute("UPDATE atm.member SET changePinRequest = " + true + " WHERE memberID = " + this.memberID.get());
                return true;
            }
            else
            {
    ...
    public boolean forgotPin(int possibleID, String possibleAddress)
    {
        ...
        try {
            ...
            if (memberInfo.next() != false) {
                statement2.execute("UPDATE atm.member SET changePinRequest = " + true + " WHERE memberID = " + possibleID);
                return true;
            }
            else
            {
