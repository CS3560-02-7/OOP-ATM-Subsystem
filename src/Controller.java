...
public class Controller implements Initializable {
    ...
    private void alertScene(int alerttype) throws IOException{
        ...
        if(alerttype == 7)
        {
            label.setText("You do not have a savings account to transfer to.");
        }
        if(alerttype == 8)
        {
            label.setText("You do not have a checking account to transfer to.");
        }
        if(alerttype == 9)
        {
            label.setText("                  Select your checking or savings account if you have one. \n   If you would like to change your pin, you can make a request to change pin.   ");
        }
        if(alerttype == 10)
        {
            label.setText("                  Choose the type of transaction you would like to start. \n   Alternatively you can view your transaction history or balance for this account.   ");
        }
    ...
    public void forgotPin(ActionEvent event) throws IOException {
        ...
        Label label = new Label();
        label.setText("Please enter your physical address and member ID.");
    ...
    public void changePin(ActionEvent event) throws IOException {
        ...
        Label label = new Label();
        label.setText("Please enter current PIN.");
        GridPane.setConstraints(label, 0, 2);
        grid.getChildren().add(label);
    ...
    public void toTransferChecking() throws IOException {
        if(!Objects.isNull(myMember.getSavingsAccount()))
        {
            try {
                changeScenes(12);
            } catch (IOException e) {
    ...
    public void toTransferSavings() throws IOException {
        if(!Objects.isNull(myMember.getCheckingAccount()))
        {
            try {
                changeScenes(13);
            } catch (IOException e) {
    ...
    public void selectionHelpButton() throws IOException {
        alertScene(9);
    }

    public void accountHelpButton() throws IOException {
        alertScene(10);
    }
